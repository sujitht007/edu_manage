        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              ...
              <span className="ml-2 text-2xl font-bold text-gray-900">{siteName}</span>
            </div>
            ...
            <div className="flex items-center space-x-4">
              {user ? (
                ...
                <div className="flex items-center space-x-4">
                  ...
                  {(studentRegistrationOpen || instructorRegistrationOpen) && (
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              {!user && (studentRegistrationOpen || instructorRegistrationOpen) && (
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400">&copy; {currentYear} {siteName}. All rights reserved.</p>
