...
import { ClockIcon, ExclamationTriangleIcon, CogIcon } from '@heroicons/react/24/outline';
  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        >
          <div className="text-center">
            <CogIcon className="h-12 w-12 mx-auto text-blue-600 mb-4" />
        ...
        >
          <div className="text-center">
            <ClockIcon className="h-12 w-12 mx-auto text-green-600 mb-4" />
